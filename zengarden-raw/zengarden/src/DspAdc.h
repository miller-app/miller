...
class DspAdc : public DspObject {
  ...
  public:
    ...
    // This object doesn't do anything with audio, it only provides buffers. It
    // should not be included in the dsp list
...
inline const char *DspAdc::getObjectLabel() { return "adc~"; }

inline std::string DspAdc::toString() { return DspAdc::getObjectLabel(); }
