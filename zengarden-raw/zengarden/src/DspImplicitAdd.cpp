...
MessageObject *DspImplicitAdd::newObject(PdMessage *initMessage,
                                         PdGraph *graph) {
    return new DspImplicitAdd(initMessage, graph);
}

DspImplicitAdd::DspImplicitAdd(PdMessage *initMessage, PdGraph *graph)
...
void DspImplicitAdd::processSignal(DspObject *dspObject, int fromIndex,
                                   int toIndex) {
