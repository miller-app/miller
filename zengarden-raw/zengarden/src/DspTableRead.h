...
inline const char *DspTableRead::getObjectLabel() { return "tabread~"; }

inline ObjectType DspTableRead::getObjectType() { return DSP_TABLE_READ; }

inline char *DspTableRead::getName() { return name; }
