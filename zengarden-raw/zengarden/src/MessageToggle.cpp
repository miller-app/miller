...
MessageObject *MessageToggle::newObject(PdMessage *initMessage,
                                        PdGraph *graph) {
    return new MessageToggle(initMessage, graph);
}

MessageToggle::MessageToggle(PdMessage *initString, PdGraph *graph)
...
const char *MessageToggle::getObjectLabel() { return "toggle"; }
