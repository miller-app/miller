...
inline const char *DspDelayWrite::getObjectLabel() { return "delwrite~"; }

inline ObjectType DspDelayWrite::getObjectType() { return DSP_DELAY_WRITE; }

inline const char *DspDelayWrite::getName() { return name; }
