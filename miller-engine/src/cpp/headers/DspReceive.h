...
inline const char *DspReceive::getName() { return name; }

inline const char *DspReceive::getObjectLabel() { return "receive~"; }

inline ObjectType DspReceive::getObjectType() { return DSP_RECEIVE; }
