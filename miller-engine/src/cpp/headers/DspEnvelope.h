...
class DspEnvelope : public DspObject {
  ...
  public:
    ...
    /*
     * @param windowSize  The window size in samples of the analysis. Defaults
     * to 1024.
     * @param windowInterval  The window interval in samples of the analysis.
     * The interval must be a multiple of the block size. If not, then it is
     * reset to the nearest multiple. Defaults to windowSize/2, according to the
...
inline const char *DspEnvelope::getObjectLabel() { return "env~"; }
