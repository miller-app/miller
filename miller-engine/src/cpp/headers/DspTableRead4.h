...
inline const char *DspTableRead4::getObjectLabel() { return "tabread4~"; }

inline ObjectType DspTableRead4::getObjectType() { return DSP_TABLE_READ4; }

inline char *DspTableRead4::getName() { return name; }
