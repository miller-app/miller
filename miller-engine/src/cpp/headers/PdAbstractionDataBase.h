...
/**
 * This class is used to register memory mapped abstractions so that the
 * PdFileParser can find them while parsing a patch.
 *
 * Every PdContext has its own PdAbstractionDatabase instance. The user can
 * register / unregister memorymapped abstractions using the ZenGarden functions
 * declared in ZenGarden.h:
